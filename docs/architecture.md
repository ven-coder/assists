...
- **发布**：Maven Central 产物为 `io.github.ven-coder:assists-base:3.5.4`（及同 groupId 下的 `assists-web`、`assists-mp`、`assists-log`、`assists-ime`、`assists-opcv`）。历史版本仍可通过 JitPack 坐标 `com.github.ven-coder.assists:*` 引用。
